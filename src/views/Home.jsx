                                ...
                                return (
                                    <div key={contact.id} className='border border-2 mb-3 rounded-pill'>
                                        <div className="row">
                                            ...
                                            <div className="col-md-2 p-2">
                                                <button type="button" class="btn btn-danger" onClick={()=>actions.deleteContact(contact.id)}>Borrar</button>
                                                <Link  class="btn btn-primary" to={"/editcontact/"+contact.id}>Editar</Link>
                                            </div>
                                        </div>
